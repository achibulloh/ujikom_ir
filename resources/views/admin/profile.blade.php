...
<meta charset="utf-8">
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="{{ asset('assets/image/logo_bpi.png') }}" />
...
<body>
    ...
    ***********************************-->
    <!-- Required vendors -->
		...
		<script src="{{ asset('assets/dsadmin/vendor/bootstrap-select/dist/js/bootstrap-select.min.js') }}"></script>
	...
	<script src="{{ asset('assets/dsadmin/vendor/lightgallery/js/lightgallery-all.min.js') }}"></script>
