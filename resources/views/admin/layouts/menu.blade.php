					...
					<ul class="metismenu" id="menu">
						<li class="dropdown header-profile">
							...
							<div class="dropdown-menu dropdown-menu-end">
								...
								<a href="/logout/id-{{ auth()->user()->id }}" class="dropdown-item ai-icon">
						...
						<li><a href="/activity" class="ai-icon" aria-expanded="false">
								<i class="flaticon-013-checkmark"></i>
								<span class="nav-text">Activity Log Users</span>
							</a>
						</li>
