            ...
            >
              <div class="w-full text-center">
                ...
                <p class="text-xl">
                   ANDA TIDAK PUNYA
                  <br/>
                  PRODUK APA PUN UNTUK MENUNJUKKAN
                </p>
              </div>
            </div>
            <div
    ...
    >
      ...
      >
        <div id="receipt-content" class="text-left w-full text-sm p-6 overflow-auto">
          <div class="text-center">
            <img src="img/receipt-logo.png" alt="Smart Casier" class="mb-3 w-8 h-8 inline-block">
            <h2 class="text-xl font-semibold">Smart Casier</h2>
            <p>CABANG BANDUNG</p>
          </div>
